...
import translationFr from "../../../../locales/fr/oceania/australia/northern-territory/index.json"
import translationEn from "../../../../locales/en/oceania/australia/northern-territory/index.json"
import {
  CityHomeSection,
  MainTitleSection,
  SectionContent,
...
import HomeImage from "../../../../images/oceania/australia/northern-territory/northern-territory-home.jpg"
...
const namespace = "oceania/australia/northern-territory/index"
i18n.addResourceBundle("fr", namespace, translationFr)
i18n.addResourceBundle("en", namespace, translationEn)
const currentPageId = "northern-territory"
  ...
  return (
    <>
      ...
      <AustraliaBlogLayout page={currentPageId} location={location}>
        ...
        <WeatherForHomePage
          entries={australiaWeatherEntries(i18n.languageCode).filter((entry) => entry.id === "northern-territory")}
