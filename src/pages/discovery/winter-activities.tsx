...
import translationFr from "../../locales/fr/discovery/winter-activities.json"
import translationEn from "../../locales/en/discovery/winter-activities.json"
...
const namespace = "discovery/winter-activities"
i18n.addResourceBundle("fr", namespace, translationFr)
i18n.addResourceBundle("en", namespace, translationEn)
const currentPageId = "winter-activities"
...
const IndexPage: React.FunctionComponent<PageProps> = ({ location }) => {
  ...
  const countries = getArticles({
    ...
    card: false,
    development,
    pointOfInterests: ["winter-activities"],
  })
