...
import translationFr from "../../../locales/fr/organisation/when-to-go/summer.json"
import translationEn from "../../../locales/en/organisation/when-to-go/summer.json"
...
const namespace = "organisation/when-to-go/summer"
...
const IndexPage: React.FunctionComponent<PageProps> = ({ location }) => {
  ...
  return (
    <>
      ...
      />
      <PrimaryBlogLayoutWithDrawer page="summer" location={location}>
