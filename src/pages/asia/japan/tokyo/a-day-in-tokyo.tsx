  ...
  return (
    <>
      ...
      <BlogLayout page="a-day-in-tokyo">
        ...
        <JapanDivider />
        <p>
          Ce n’est pas forcément un endroit incontournable mais nous dormions pas loin et nous avons beaucoup aimé nous
          promener dans ces rues aux allures de Time Square. Le soir était tout autant intéressant, avenue animé, bar
          bondé et musique d’ambiance.
        </p>
        <GroupOfImages>
          <ImageAsPortrait>
            <TokyoYasukuni1Image />
