...
import translationFr from "../../../../locales/fr/asia/malaysia/east-malaysia/index.json"
import translationEn from "../../../../locales/en/asia/malaysia/east-malaysia/index.json"
import {
  CityHomeSection,
  MainTitleSection,
  SectionContent,
...
import HomeImage from "../../../../images/asia/malaysia/east-malaysia/east-malaysia-home.jpg"
...
const currentPageId = "east-malaysia"
  ...
  return (
    <>
      ...
      <MalaysiaBlogLayout page={currentPageId} location={location}>
        ...
        <WeatherForHomePage
          entries={malaysiaWeatherEntries(i18n.languageCode).filter((entry) => entry.id === "east")}
