  ...
  return (
    ...
    >
      ...
      <g {...propsFor("cu-chi-tunnels")}>
        <rect width="150" height="80" x="350" y="520" />
        <text x="350" y="535">
          Ho Chi Minh
        </text>
        <g transform="translate(390 540) scale(0.9)">
          <Train />
        </g>
      </g>
      <g {...propsFor("my-tho")}>
        <rect width="150" height="80" x="350" y="600" />
        <text x="410" y="640">
          My Tho
        </text>
      ...
      <g {...propsFor("can-tho")}>
        <rect width="150" height="80" x="170" y="650" />
        <text x="170" y="690">
          Can Tho
        </text>
        <g transform="translate(270 650) scale(0.9)">
          <Train />
        </g>
      </g>
    </svg>
...
const Train: FunctionComponent<SVGAttributes<any>> = (props) => {
  return (
    <svg {...props}>
      ...
      <path d="m30.445 11h-17.445c-.551 0-1 .449-1 1v3h17.226c.231-1.354.634-2.696 1.219-4z" />
      <path d="m32.102 27.206c-.947-1.33-1.675-2.745-2.191-4.206h-21.911v12h29.971z" />
      <path d="m20 47h12v2h-12z" />
      <path d="m29.012 17h-18.012c-1.654 0-3 1.346-3 3v1h21.341c-.281-1.317-.386-2.659-.329-4z" />
      <circle cx="46" cy="18" r="9" />
      <path d="m6.414 59-2 2h43.172l-2-2z" />
      <path d="m59.37 11.056c-2.6-5.044-7.599-8.056-13.37-8.056s-10.77 3.012-13.37 8.056c-2.517 4.882-2.111 10.478 1.085 14.968l12.285 16.314 12.3-16.335c3.181-4.469 3.587-10.065 1.07-14.947zm-13.37 17.944c-6.065 0-11-4.935-11-11s4.935-11 11-11 11 4.935 11 11-4.935 11-11 11z" />
      <path d="m8.414 57h35.172l-2-2h-31.172z" />
      <path d="m12.414 53h27.172l-2-2h-23.172z" />
      <path d="m20 43h12v2h-12z" />
    </svg>
  )
}
